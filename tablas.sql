...
CREATE TABLE QUETOCA (
    ...
    CONSTRAINT FK_QUETOCA_PROYECTO FOREIGN KEY (PROYECTO) REFERENCES ARTISTA(ID_ART) ON UPDATE CASCADE,
    CONSTRAINT FK_QUETOCA_MUSICO FOREIGN KEY (MUSICO) REFERENCES ARTISTA(ID_ART) ON UPDATE CASCADE
);
/*
GENERO(nombre) 
  PK(nombre)
